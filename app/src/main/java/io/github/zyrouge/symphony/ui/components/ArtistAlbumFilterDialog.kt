...
fun ArtistAlbumFilterDialog(
    ...
    LaunchedEffect(Unit) {
        ...
        val filter = settings.uiArtistViewAlbumFilter
    ...
    ScaffoldDialog(
        ...
        title = { Text("Artist Album Filter") },
        titleTrailing = {
            IconButton(
                enabled = !isLoading,
                ...
                onClick = {
                    coroutineScope.launch {
                        context.symphony.settings.updateData { settings ->
                            settings.copy {
                                uiArtistViewAlbumFilter = fieldStates
        ...
        ArtistSavePresetDialog(
            ...
            onSave = { newPreset ->
                ...
                coroutineScope.launch {
                    context.symphony.settings.updateData { settings ->
                        settings.copy {
                            uiArtistViewAlbumFilterPresets.clear()
                            uiArtistViewAlbumFilterPresets.addAll(toSave)
                        }
                    }
                }
...
@OptIn(ExperimentalLayoutApi::class)
@Composable
private fun ArtistFilterSection(
